using TensorNetworkQuantumSimulator: sample, maxlinkdim
...
"""
function sample(ψt, nsamples, projected_message_rank=maxlinkdim(ψt)*5, norm_message_rank=maxlinkdim(ψt)^2, partition_by="Column")
     return sample(ψt, nsamples; projected_message_rank=projected_message_rank,
